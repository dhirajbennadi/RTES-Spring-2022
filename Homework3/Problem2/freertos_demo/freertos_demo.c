    ...
    int main(void)
    {
        ...
        one_shot_timer = xTimerCreate("One Shot Timer", 10, pdTRUE, (void*)0 , myTimerCallback);
        ...
        for (;;)
        {
            if(syncVariableFromTask1toTask2 == 0)
            {
                ...
                if( xSemaphoreTake( xSemaphoreMutex, ( TickType_t ) 10000 ) == pdTRUE )
                {
                    ...
                    FIB_TEST(50, 750);
                    //UARTprintf("Task 2 Ended\n\r");
                    endTime = xTaskGetTickCount();

                    int32_t elapsed = endTime - startTime;
